...
def get_str_automaton(end_chr: str):
    ...
    automaton[state_id][state_id] = lambda c: is_unescaped(c)
    ...
    automaton[state_id + 2][state_id + 3] = lambda c: is_hex(c)
    automaton[state_id + 3][state_id + 4] = lambda c: is_hex(c)
    automaton[state_id + 4][state_id + 5] = lambda c: is_hex(c)
    automaton[state_id + 5][state_id] = lambda c: is_hex(c)
...
def get_number_automaton(end_chr: str):
    ...
    automaton[state_id + 4][state_id + 5] = lambda c: is_digit(c)
    automaton[state_id + 5][state_id + 5] = lambda c: is_digit(c)
    ...
    automaton[state_id + 2][state_id + 2] = lambda c: is_digit(c)
    ...
    automaton[state_id + 6][state_id + 9] = lambda c: is_digit(c)
    automaton[state_id + 7][state_id + 9] = lambda c: is_digit(c)
    automaton[state_id + 8][state_id + 9] = lambda c: is_digit(c)
    automaton[state_id + 9][state_id + 9] = lambda c: is_digit(c)
